package LAB_303_11_7_Generic_Method_Class;
import  java.util.*;
...
@return The phone number associated with the name; if the name does
    ...
    /**
     * Associates a given name with a given phone number. If the name already exists in the phone directory, then the new number replaces
